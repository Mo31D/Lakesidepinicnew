...
for(const route of routes){
 ...
 const pageProduct=page.kind==='product'?data.products.find(p=>p.id===page.productId):null;\n const socialImage=pageProduct?.image?origin+pageProduct.image:origin+'/brand/identity-board.jpeg';\n const titleText=page.kind==='product'?page.title+' | Lakeside Picnic Ambleside':page.title+' | Lakeside Picnic';\n const robotsMeta=page.kind==='selection'?'<meta name="robots" content="noindex,follow">':'';\n const html='<!doctype html><html lang="en" data-route="'+escape(route)+'" data-base="'+base+'"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>'+escape(titleText)+'</title>'+robotsMeta+'<meta name="description" content="'+escape(page.description)+'"><link rel="canonical" href="'+origin+page.path+'"><meta property="og:type" content="'+(page.kind==='product'?'product':'website')+'"><meta property="og:site_name" content="Lakeside Picnic"><meta property="og:locale" content="en_GB"><meta property="og:title" content="'+escape(titleText)+'"><meta property="og:description" content="'+escape(page.description)+'"><meta property="og:url" content="'+origin+page.path+'"><meta property="og:image" content="'+socialImage+'"><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title" content="'+escape(titleText)+'"><meta name="twitter:description" content="'+escape(page.description)+'"><meta name="twitter:image" content="'+socialImage+'"><link rel="icon" href="'+base+'/favicon.svg"><link rel="stylesheet" href="'+base+'/site.css"><script type="application/ld+json">'+structuredData(data,page)+'</script></head><body><div id="root">'+render(data,route,base)+'</div><script type="application/json" id="lp-catalogue">'+serialised+'</script><script defer src="'+base+'/site.js"></script></body></html>';
...
fs.writeFileSync('404.html','<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Page not found | Lakeside Picnic</title><meta name="robots" content="noindex,follow"><style>body{font:18px/1.6 system-ui,sans-serif;margin:10vh auto;padding:24px;max-width:640px;color:#1b3c34}a{color:inherit}</style></head><body><main><h1>This page has wandered off.</h1><p>Let’s get you back to the good things.</p><a href="https://www.lakesidepicnic.co.uk/">Back to the shop</a></main></body></html>');
