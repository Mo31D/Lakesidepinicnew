...
for(const route of routes){
 ...
 const html='<!doctype html><html lang="en" data-route="'+escape(route)+'" data-base="'+base+'"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>'+escape(page.title)+' | Lakeside Picnic</title><meta name="description" content="'+escape(page.description)+'"><link rel="canonical" href="'+origin+page.path+'"><meta property="og:type" content="website"><meta property="og:site_name" content="Lakeside Picnic"><meta property="og:locale" content="en_GB"><meta property="og:title" content="'+escape(page.title)+' | Lakeside Picnic"><meta property="og:description" content="'+escape(page.description)+'"><meta property="og:url" content="'+origin+page.path+'"><meta property="og:image" content="'+origin+'/brand/identity-board.jpeg"><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title" content="'+escape(page.title)+' | Lakeside Picnic"><meta name="twitter:description" content="'+escape(page.description)+'"><meta name="twitter:image" content="'+origin+'/brand/identity-board.jpeg"><link rel="icon" href="'+base+'/favicon.svg"><link rel="stylesheet" href="'+base+'/site.css"><script type="application/ld+json">'+structuredData(data,page)+'</script></head><body><div id="root">'+render(data,route,base)+'</div><script type="application/json" id="lp-catalogue">'+serialised+'</script><script defer src="'+base+'/site.js"></script></body></html>';
